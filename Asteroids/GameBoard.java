	...
	public GameBoard()
    {
        ...
        addKeyListener(new KeyListener() {
			...
			public void keyPressed(KeyEvent e) {
				...
				// NEW Checks if Enter key is pressed ---------------
			    ...
			    else if (e.getKeyCode()==KeyEvent.VK_ENTER && GameDrawingPanel2.theShip.getAmmo()>0){
			    	System.out.println("Shoot");
			    	GameDrawingPanel2.theShip.setAmmo(GameDrawingPanel2.theShip.getAmmo()-1);
			    	...
			    	System.out.println("RotationAngle " + GameDrawingPanel2.theShip.getRotationAngle()+"Ammo Left: "+GameDrawingPanel2.theShip.getAmmo());
			    	}
