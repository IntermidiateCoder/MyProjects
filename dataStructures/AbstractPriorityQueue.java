...
public abstract class AbstractPriorityQueue<K,V>
	...
	protected AbstractPriorityQueue() { this( (Comparator<K>) new DefaultComparator<K>()); }
	...
	// Sorts sequence S, using initially empty priority queue P to produce the order.(Selection sort)
