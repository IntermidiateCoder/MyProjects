...
public class Partition<E> {
	...
	private Partition<E>.Locator<E> validate(Position<E> p) throws IllegalArgumentException {
		if (!(p instanceof Locator)) throw new IllegalArgumentException("Invalid p");
		Locator<E> locator = (Partition<E>.Locator<E>) p;
		if (locator.parent == null) 
			throw new IllegalArgumentException("p is no longer in the Partition");
		return locator;
	}
